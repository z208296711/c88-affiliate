package com.c88.affiliate.config.sharding.runner;
...
public class AutoConfigDateNodes implements ApplicationRunner {
    ...
    private final String databaseName = "affiliate";
    ...
    private void refreshShardingNodes(ShardingSphereDataSource ds) {
        ...
        contextManager.alterRuleConfiguration(databaseName, addRuleConfigs);
        // 将新数据添加进contex中
